APP.Name = "Fur Fox"
APP.Icon = "https://raw.githubusercontent.com/KredeGC/GPhone/master/gphone/firefox.png"
function APP.Run( frame, w, h )
	...
	url:SetPos( 6 + size, 6 )
	url:SetSize( w - size*2 - 12, size - 12 )
